...
ivars.inputFiles = "file:_file_flag_"

#ivars.inputFiles = "file:./reco_test16.root"
ivars.outputFile = './forest_data.root'
ivars.maxEvents = -1
...
process.source.inputCommands = cms.untracked.vstring("keep *",
                                                     "drop *_hiSignal*_*_*",
                                                     "drop *_*GenJet*_*_*",
                                                     "drop *_*GenPar*_*_*"#, "drop *_gen*_*_*"
                                                     )
...
process.genpana = cms.EDAnalyzer("GenParticleCounter",
                                 ...
                                 VertexProducer = cms.untracked.string("offlinePrimaryVerticesWithBS")
                                 )
